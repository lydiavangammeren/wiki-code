  ...
  return (
    <Card sx={{ maxWidth: 1200, m: 3 }}>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          <Typography paragraph>Code example:</Typography>
